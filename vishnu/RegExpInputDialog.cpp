...
namespace vishnu
{
    ...
    : QDialog(parent)
  {
    ...
    QObject::connect(_text, SIGNAL(textChanged(QString)), this, SLOT(checkValid(QString)));
  ...
  void RegExpInputDialog::setRegularExpression(const QRegularExpression &regularExpression)
  {
